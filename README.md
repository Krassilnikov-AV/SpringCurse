...
_ _ _ _ 
- SpringApp_InitDestroyAndFactory - в примере рассматривается жизненный цикл бина, при помощи создания методов public  void doMyInit() и public  void doMyDestroy().</p>
